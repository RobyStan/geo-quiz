...
class GuessCapitalScreen extends StatefulWidget {
  final String region;
  ...
  @override
  State<GuessCapitalScreen> createState() => _GuessCapitalScreenState();
}

class _GuessCapitalScreenState extends State<GuessCapitalScreen> {
  ...
  void _checkAnswer(String answer) {
    ...
    final correctCapitalRaw = currentCountry['capital'];
    if (correctCapitalRaw == null || correctCapitalRaw.isEmpty) {
      setState(() {
        message = 'No capital defined for this country.';
    ...
    final correctCapital = correctCapitalRaw.toLowerCase();
